            ...
            <div class="sl-wrap">
               <div class="sl-sugg">
                  ...
                  <div class="sl-sugg-button-container">
                     ...
                     <div role="button" class="goog-inline-block jfk-button jfk-button-standard jfk-button-collapse-left jfk-button-collapse-right jfk-button-checked jfk-button-clear-outline" tabindex="0" aria-pressed="true" value="en" id="sugg-item-en" style="user-select: none;"><span class="ink-container language-selector-ripple ink-ripple-animation" style="height: 105px; width: 105px; top: -29.5px; left: -24.125px;"></span>English</div>
            ...
            <div class="input-full-height-wrapper tlid-input-full-height-wrapper">
               <div class="source-input">
                  ...
                  <div id="spelling-correction" class="tlid-spelling-correction spelling-correction gt-spell-correct-message" style="">
                     Did you mean: <a href="javascript:void(0)" style="direction: ltr; text-decoration: none;"><b><i>Width</i></b></a>
                  ...
                  <div class="source-footer-wrap source-or-target-footer">
                     ...
                     <div class="character-count tlid-character-count">
                        <div class="cc-ctr normal">4/5000</div>
               ...
               <div class="result-footer source-or-target-footer tlid-copy-target">
                  ...
                  <div class="more-wrapper">
                     ...
                     <div class="moremenu goog-menu" role="menu" aria-haspopup="true" style="user-select: none; display: none;">
                        <div class="goog-menuitem tlid-suggest-edit-menu-item" role="menuitem" style="user-select: none;" id=":57">
                           <div class="goog-menuitem-content">Suggest an edit</div>
                        </div>
                        <div class="goog-menuitem tlid-share-translation-menu-item" role="menuitem" style="user-select: none;" id=":58">
