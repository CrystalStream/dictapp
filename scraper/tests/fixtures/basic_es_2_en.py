      ...
      <div class="tlid-input input">
         <div class="tlid-language-bar ls-wrap">
            <div class="sl-wrap">
               <div class="sl-sugg">
                  ...
                  <div class="sl-sugg-button-container">
                     ...
                     <div role="button" class="goog-inline-block jfk-button jfk-button-standard jfk-button-collapse-left jfk-button-collapse-right" tabindex="0" aria-pressed="false" value="es" id="sugg-item-es" style="user-select: none;">Spanish</div>
            ...
            <div class="sl-selector lang_list">
               <div class="lang-btn"><a class="ls-select new-ls-select sl-button tlid-open-small-source-language-list" aria-label="English" tabindex="0">English</a></div>
            </div>
            <div class="swap-wrap">
            ...
            <div class="tl-wrap">
               <div class="tl-sugg">
                  <div class="ls-left-arrow"></div>
                  <div class="sl-sugg-button-container">
                     <div role="button" class="goog-inline-block jfk-button jfk-button-standard jfk-button-collapse-right jfk-button-checked" tabindex="0" aria-pressed="true" value="es" id="sugg-item-es" style="user-select: none;">Spanish</div>
                     <div role="button" class="goog-inline-block jfk-button jfk-button-standard jfk-button-collapse-left jfk-button-collapse-right" tabindex="0" aria-pressed="false" value="en" id="sugg-item-en" style="user-select: none;">English</div>
            ...
            <div class="tl-selector lang_list">
               <div class="lang-btn"><a class="ls-select new-ls-select tl-button tlid-open-small-target-language-list" aria-label="Spanish" tabindex="0">Spanish</a></div>
            </div>
         </div>
            ...
            <div class="input-full-height-wrapper tlid-input-full-height-wrapper">
               <div class="source-input">
                  <div id="input-wrap" class="tlid-input-area input-area less-padding">
                     ...
                     <textarea id="source" class="orig tlid-source-text-input goog-textarea" rows="1" spellcheck="false" autocapitalize="off" autocomplete="off" autocorrect="off" style="overflow: auto hidden; box-sizing: border-box; height: 102px; direction: ltr; padding-bottom: 18px;"></textarea>
                     <div class="text-dummy">cars
                     </div>
                     <div id="gt-src-is" style="user-select: none; direction: ltr; text-align: left; left: 0px; top: 10px; display: none;" class="gt-is-mobile gt-is" role="menu">
                  ...
                  <div class="source-footer-wrap source-or-target-footer">
                     <div class="source-input-tools" id="gt-input-tool">
                        <div id="itamenu">
                           <span class="ita-kd-inputtools-div">
                              <div class="goog-container goog-container-vertical" tabindex="-1" style="user-select: none;"><a class="ita-kd-icon-button ita-kd-inputtool-icon ita-kd-small ita-kd-left" tabindex="0" data-tooltip="Turn on Virtual Keyboard" aria-label="Turn on Virtual Keyboard" data-tooltip-align="t,c" style="user-select: none;"><span class="ita-kd-img ita-icon-0 ita-kd-icon ita-kd-icon-span" style="user-select: none;"></span></a><a class="ita-kd-icon-button ita-kd-dropdown ita-kd-right" tabindex="0" data-tooltip="Select Input Tool" aria-label="Select Input Tool" data-tooltip-align="t,c" style="user-select: none;"><span class="ita-kd-img ita-kd-arrow ita-kd-icon-span" style="user-select: none;"></span></a></div>
                           </span>
                        </div>
                     </div>
                     <div class="character-count tlid-character-count">
                        <div class="cc-ctr normal">5/5000</div>
                     ...
                     <div class="source-footer">
                        <div class="speech-wrap source-or-target-footer-button left-positioned">
                           ...
                           <div id="gt-speech" class="speech-button goog-toolbar-button" aria-label="Turn on voice input" data-tooltip-align="t,c" aria-pressed="false" role="button" aria-disabled="false" tabindex="0" data-tooltip="Turn on voice input" style="user-select: none;">
         ...
         <div class="tlid-result result-dict-wrapper">
            <div class="result tlid-copy-target">
               ...
               <div class="text-wrap tlid-copy-target">
                  <div class="result-shield-container tlid-copy-target" tabindex="0"><span class="tlid-translation translation" lang="es"><span title="">Coches</span></span><span class="tlid-translation-gender-indicator translation-gender-indicator"></span><span class="tlid-trans-verified-button trans-verified-button" style="" role="button"></span></div>
               </div>
               ...
               <div class="result-footer source-or-target-footer tlid-copy-target">
                  ...
                  <div class="more-wrapper">
                     ...
                     <div class="moremenu goog-menu" role="menu" aria-haspopup="true" style="user-select: none; display: none;">
                        <div class="goog-menuitem tlid-suggest-edit-menu-item" role="menuitem" style="user-select: none;" id=":n">
                           <div class="goog-menuitem-content">Suggest an edit</div>
                        </div>
                        <div class="goog-menuitem tlid-share-translation-menu-item" role="menuitem" style="user-select: none;" id=":o">
