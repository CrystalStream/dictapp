         ...
         <div class="tlid-language-bar ls-wrap">
            <div class="sl-wrap">
               <div class="sl-sugg">
                  ...
                  <div class="sl-sugg-button-container">
                     ...
                     <div role="button" class="goog-inline-block jfk-button jfk-button-standard jfk-button-collapse-left jfk-button-collapse-right jfk-button-checked jfk-button-clear-outline" tabindex="0" aria-pressed="true" value="es" id="sugg-item-es" style="user-select: none;"><span class="ink-container language-selector-ripple ink-ripple-animation" style="height: 105px; width: 105px; top: -26.5px; left: 14.875px;"></span>Spanish</div>
                     <div role="button" class="goog-inline-block jfk-button jfk-button-standard jfk-button-collapse-left jfk-button-collapse-right jfk-button-clear-outline" tabindex="0" aria-pressed="false" value="en" id="sugg-item-en" style="user-select: none;"><span class="ink-container language-selector-ripple ink-ripple-animation" style="height: 106px; width: 106px; top: -23px; left: -24.4219px;"></span>English</div>
            ...
            <div class="tl-wrap">
               <div class="tl-sugg">
                  <div class="ls-left-arrow"></div>
                  <div class="sl-sugg-button-container">
                     <div role="button" class="goog-inline-block jfk-button jfk-button-standard jfk-button-collapse-right jfk-button-checked" tabindex="0" aria-pressed="true" value="en" id="sugg-item-en" style="user-select: none;">English</div>
                     ...
                     <div role="button" class="goog-inline-block jfk-button jfk-button-standard jfk-button-collapse-left jfk-button-collapse-right" tabindex="0" aria-pressed="false" value="ar" id="sugg-item-ar" style="user-select: none;">Arabic</div>
                  </div>
                  <div class="ls-right-arrow"></div>
               </div>
               <div class="sugg-fade"></div>
         ...
         <div class="source-wrap">
            <div class="input-full-height-wrapper tlid-input-full-height-wrapper">
               <div class="source-input">
                  ...
                  <div id="spelling-correction" class="tlid-spelling-correction spelling-correction gt-spell-correct-message" style="">
                     Did you mean: <a href="javascript:void(0)" style="direction: ltr; text-decoration: none;"><b><i>Jugando</i></b></a>
                  ...
                  <div class="source-footer-wrap source-or-target-footer">
                     ...
                     <div class="character-count tlid-character-count">
                        <div class="cc-ctr normal">7/5000</div>
               ...
               <div class="result-footer source-or-target-footer tlid-copy-target">
                  ...
                  <div class="more-wrapper">
                     ...
                     <div class="moremenu goog-menu" role="menu" aria-haspopup="true" style="user-select: none; display: none;">
                        <div class="goog-menuitem tlid-suggest-edit-menu-item" role="menuitem" style="user-select: none;" id=":3j">
                           <div class="goog-menuitem-content">Suggest an edit</div>
                        </div>
                        <div class="goog-menuitem tlid-share-translation-menu-item" role="menuitem" style="user-select: none;" id=":3k">
