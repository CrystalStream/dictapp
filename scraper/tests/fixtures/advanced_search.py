            ...
            <div class="sl-wrap">
               <div class="sl-sugg">
                  ...
                  <div class="sl-sugg-button-container">
                     ...
                     <div role="button" class="goog-inline-block jfk-button jfk-button-standard jfk-button-collapse-left jfk-button-collapse-right jfk-button-clear-outline" tabindex="0" aria-pressed="false" value="en" id="sugg-item-es" style="user-select: none;"><span class="ink-container language-selector-ripple ink-ripple-animation" style="height: 105px; width: 105px; top: -29.5px; left: -24.125px;"></span>English</div>
                     <div role="button" class="goog-inline-block jfk-button jfk-button-standard jfk-button-collapse-left jfk-button-collapse-right jfk-button-checked jfk-button-clear-outline" tabindex="0" aria-pressed="true" value="es" id="sugg-item-en" style="user-select: none;"><span class="ink-container language-selector-ripple ink-ripple-animation" style="height: 106px; width: 106px; top: -30px; left: -0.9375px;"></span>Spanish</div>
            ...
            <div class="input-full-height-wrapper tlid-input-full-height-wrapper">
               <div class="source-input">
                  <div id="input-wrap" class="tlid-input-area input-area less-padding">
                     ...
                     <div class="text-dummy">Yo quisiera comprarme la mascara pero no se si me alcance</div>
                  ...
                  <div class="source-footer-wrap source-or-target-footer">
                     ...
                     <div class="character-count tlid-character-count">
                        <div class="cc-ctr normal">57/5000</div>
         ...
         <div class="tlid-result result-dict-wrapper">
            <div class="result tlid-copy-target">
               ...
               <div class="text-wrap tlid-copy-target">
                  <div class="result-shield-container tlid-copy-target" tabindex="0"><span class="tlid-translation translation" lang="en"><span title="" class="">I would like to buy the mask but I don't know if it reaches me</span></span><span class="tlid-translation-gender-indicator translation-gender-indicator"></span><span class="tlid-trans-verified-button trans-verified-button" style="display:none" role="button"></span></div>
               </div>
               ...
               <div class="result-footer source-or-target-footer tlid-copy-target">
                  ...
                  <div class="more-wrapper">
                     ...
                     <div class="moremenu goog-menu" role="menu" aria-haspopup="true" style="user-select: none; display: none;">
                        <div class="goog-menuitem tlid-suggest-edit-menu-item" role="menuitem" style="user-select: none;" id=":ct">
                           <div class="goog-menuitem-content">Suggest an edit</div>
                        </div>
                        <div class="goog-menuitem tlid-share-translation-menu-item" role="menuitem" style="user-select: none;" id=":cu">
